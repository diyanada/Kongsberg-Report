...
{ 
	include_once('Project_pic_form.php');
}
?>
...
<div id="body">
  <table align="center" width="450" height="140" id="input_table">
    <tr>
      <th colspan="2" align="center"> Project Banner Picture </th>
    </tr>
    <form action="" method="post" enctype="multipart/form-data" onsubmit="return validateForm()" name="myForm">
      ...
      <tr>
        ...
        <td colspan="1"><input type="file" name="fileToUpload" id="fileToUpload" accept="image/jpeg" ></td>
      </tr>
      <tr>
