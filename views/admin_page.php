<?php
function admin_page($body = NULL, $title = "Kongsberg Reports", $js = array(), $css = array(), $pram = NULL){
...
EOSS;
include('utility/header_admin.php');
if ($body != NULL)		include ($body);

echo "</body></html>";
}

function admin_page_pn($body = NULL, $title = "Kongsberg Reports", $js = array(), $css = array(), $pram = NULL){
